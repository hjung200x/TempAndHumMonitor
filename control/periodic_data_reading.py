...
def loop():
  ...
  temperature = SHT3X.get_temperature_C()
  humidity = SHT3X.get_humidity_RH()
  print(f"environment temperature(°C): {temperature: .2f} C, relative humidity(%%RH): {humidity: .2f} %%RH")
